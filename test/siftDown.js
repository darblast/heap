...
describe('sift down', function () {
  describe('cmp', function () {
    ...
    it('one element', function () {
      const data = [42];
      Heap.siftDownCmp(data, data.length, 0, cmp);
    ...
    it('two elements sorted 2', function () {
      const data = [42, 53];
      Heap.siftDownCmp(data, data.length, 1, cmp);
      expect(data).to.eql([42, 53]);
    });
    ...
    it('three elements 3', function () {
      const data = [42, 53, 64];
      Heap.siftDownCmp(data, data.length, 2, cmp);
      expect(data).to.eql([42, 53, 64]);
    });
  ...
  describe('min', function () {
    it('one element', function () {
      const data = [42];
      Heap.siftDownMin(data, data.length, 0);
      expect(data).to.eql([42]);
    });
    ...
    it('two elements sorted 2', function () {
      const data = [42, 53];
      Heap.siftDownMin(data, data.length, 1);
      expect(data).to.eql([42, 53]);
    });
    ...
    it('three elements 3', function () {
      const data = [42, 53, 64];
      Heap.siftDownMin(data, data.length, 2);
      expect(data).to.eql([42, 53, 64]);
    });
  ...
  describe('max', function () {
    it('one element', function () {
      const data = [42];
      Heap.siftDownMax(data, data.length, 0);
      expect(data).to.eql([42]);
    });
    ...
    it('two elements sorted 2', function () {
      const data = [42, 53];
      Heap.siftDownMax(data, data.length, 1);
      expect(data).to.eql([42, 53]);
    });
    ...
    it('three elements 3', function () {
      const data = [42, 53, 64];
      Heap.siftDownMax(data, data.length, 2);
      expect(data).to.eql([42, 53, 64]);
    });
